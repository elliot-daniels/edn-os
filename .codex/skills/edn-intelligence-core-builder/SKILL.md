...
8. On success, update deterministic development state and documentation, record decision/outcome audit events, and prepare—but do not assume authority to create—a commit.
...
- Do not discard, overwrite, broadly stage, push, merge, or deploy existing work without explicit authority.
